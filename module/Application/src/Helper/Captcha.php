...
class Captcha extends AbstractHelper {
    public $__client;
    public $__secret;
    public $__random_repository;
    public $__cleanup_time;
    public $__time_stamp_file;
    public $__alphabet;
    public $__letters;
    public $__width;
    public $__height;
    public $__color;
    public $__random_file;
    public $__random;
            ...
            )
    {
        ...
        $this->__time_stamp_file   = PUBLIC_PATH . '/img/captchas/' . $random_repository . '/__time_stamp__';
    ...
    function random ()
    {
        ...
        if (!is_dir (PUBLIC_PATH . '/img/captchas/' . $this->__random_repository))
        {
            mkdir(PUBLIC_PATH . '/img/captchas/' . $this->__random_repository, 0777, TRUE);          
        }
        ...
        {
            $handle = opendir (PUBLIC_PATH . '/img/captchas/' . $this->__random_repository);
            while (true)
            {
                ...
                {
                    $filename = PUBLIC_PATH . '/img/captchas/' . $this->__random_repository . '/' . $filename;
        ...
        for ($remaining = 20; $remaining > 0; $remaining--)
        {
            ...
            // error message.
            $filename = PUBLIC_PATH . '/img/captchas/' . $this->__random_repository . '/' . $random;
...
EOT;
        ...
        $image = str_replace ('@URL@', $this->image_url ($random), $image);
        return $image;
    }
    ...
    function validate ($random)
    {
        ...
        $file_name = PUBLIC_PATH . '/img/captchas/' . $this->__random_repository . '/' . $random;
