...
define('FPDF_FONTPATH', BASE_PATH . '/public_html/fonts/pdf');
define('FPDF_IMGPATH', BASE_PATH . '/public_html/img');

/**
 * Layout helper for logged user details.
 */
class FpdfHelper extends AbstractHelper {
    ...
    function GetTitle() {
        //    $result = iconv('UTF-16BE' ,'UTF-8' , $this->title);    
        //    return $result;
        return $this->title;
        //    
        //        $title = $this->_UTF8toUTF16($this->title);
        //        return $title;
    }
    ...
    function AddPage($orientation = '', $size = '', $info = '') {
        // Start a new page
        if ($this->state == 0)
            $this->Open();
